...
public class FindNeighborsFn implements FlatMapFunction<SparkCell, Tuple2<Tuple2<Long, Long>, Tuple2<SparkCell, Integer>>> {
    @Override
    public Iterator<Tuple2<Tuple2<Long, Long>, Tuple2<SparkCell, Integer>>> call(SparkCell sparkCell) throws Exception {
